...
export const getExportOrderList = createAsyncThunk(
  'exportOrder/list',
...
export const getExportOrderById = createAsyncThunk(
  'exportOrder/detail',
  async (id, thunkAPi) => {
    // nếu muốn dispatch 1 action khác thì dùng thunkApi.dispatch(..)
...
export const getConsignmentsByExportOrderId = createAsyncThunk(
  'exportOrder/list-consignment',
  async (params, thunkAPi) => {
    // nếu muốn dispatch 1 action khác thì dùng thunkApi.dispatch(..)
    const consignments = await exportOrderService.getListConsignmentByExportOrderId(
      params,
    );
    return consignments;
  },
...
export const getListProductInStock = createAsyncThunk(
  'exportOrder/list-product-instock',
  async (params, thunkAPi) => {
    // nếu muốn dispatch 1 action khác thì dùng thunkApi.dispatch(..)
...
export const getListConsiggnmentOfProductInStock = createAsyncThunk(
  'exportOrder/list-consignment-of-product-instock',
  async (params, thunkAPi) => {
    // nếu muốn dispatch 1 action khác thì dùng thunkApi.dispatch(..)
    const consignmenttInstock =
      await exportOrderService.getListConsignmentOfProductInStock(params);
    return consignmenttInstock;
  },
);

export const createExportOrder = createAsyncThunk(
  'exportOrder/create-export-order',
  async (exportOrder, { rejectWithValue }) => {
    try {
...
export const updateExportOrder = createAsyncThunk(
  'exportOrder/update',
  async (exportOrder, thunkAPi) => {
    return await exportOrderService.updateExportOrder(exportOrder);
  },
);

export const getReturnOrderList = createAsyncThunk(
  'returnOrder/list',
  async (params, thunkAPi) => {
    // nếu muốn dispatch 1 action khác thì dùng thunkApi.dispatch(..)
...
export const getReturnOrderById = createAsyncThunk(
  'returnOrder/detail',
  async (params, thunkAPi) => {
    // nếu muốn dispatch 1 action khác thì dùng thunkApi.dispatch(..)
